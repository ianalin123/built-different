...
This repository is initialized for the Stripe project "built-different".
...
| `ACCOUNT_NOT_ELIGIBLE` | Account not onboarded for Projects | The current account isn’t eligible for Stripe Projects.
